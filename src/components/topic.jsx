...
export default class Topic extends React.Component {
  state = {
    subTopics: {
      4: {
        Historia: [{ name: "Definición y su importancia en la vida cotidiana de los Estudios Sociales", body: "body for h1", image: " " }],
        Geografía: [{ name: "Ubicación hemisférica y continental del país.", body: "body for h1", image: ".jpg" }, { name: "Países vecinos de Costa Rica: construcción de lazos entre países centroamericanos.", body: "body for h1", image: "map_cr.jfif" }, { name: "Climas de Costa Rica.", body: "body for h1", image: "climate.jpg" }],
